...
showlist_1.grid(row=0, column=5, padx=(0, 20), pady=(10, 10))

showlist_2 = tk.Label(text=" ")
showlist_2.grid(row=1, column=5, padx=(0, 20), pady=(10, 10))

showlist_3 = tk.Label(text=" ")
showlist_3.grid(row=2, column=5, padx=(0, 20), pady=(10, 10))

showlist_3 = tk.Label(text=" ")
showlist_3.grid(row=3, column=5, padx=(0, 20), pady=(10, 10))

showlist_4 = tk.Label(text=" ")
showlist_4.grid(row=4, column=5, padx=(0, 20), pady=(10, 10))
