...
def submit():
    ...
    if size == "s" or peperoni == "yes":
        counter += 20
    elif size == "m" or peperoni == "yes":
        counter += 30
    elif size == "40" or peperoni == "yes":
        counter += 40

    if size == "s" or peperoni == "yes" or cheese == "yes":
        counter += 30
    elif size == "m" or peperoni == "yes" or cheese == "yes":
        counter += 30
    elif size == "l" or peperoni == "yes" or cheese == "yes":
        counter += 30
...
peperoni_label = tk.Label(text="Do you want a Peperoni? ")
...
cheese_label = tk.Label(text="Do you want a Cheese? ")
